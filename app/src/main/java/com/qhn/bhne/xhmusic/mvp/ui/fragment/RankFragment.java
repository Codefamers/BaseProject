...
import com.qhn.bhne.xhmusic.mvp.ui.adapter.MusicRankAdapter;
import com.qhn.bhne.xhmusic.mvp.view.MusicRankView;
import com.qhn.bhne.xhmusic.mvp.view.RankViewImpl;
...
public class RankFragment extends BaseFragment<MusicRankPresenterImpl, List<MusicRank>> implements MusicRankView<List<MusicRank>>, ClickAdapterItemListener<MusicRank> {
    ...
    @Override
    public void onClick(MusicRank data,int position) {
