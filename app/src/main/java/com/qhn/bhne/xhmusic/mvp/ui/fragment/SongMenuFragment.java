...
import com.qhn.bhne.xhmusic.mvp.presenter.impl.SongMenuPresenterImpl;
import com.qhn.bhne.xhmusic.mvp.ui.activities.MusicListActivity;
import com.qhn.bhne.xhmusic.mvp.ui.adapter.SongMenuAdapter;
import com.qhn.bhne.xhmusic.mvp.view.NormalMusicListView;
import com.qhn.bhne.xhmusic.mvp.view.SongMenuView;
...
public class SongMenuFragment extends BaseFragment<SongMenuPresenterImpl, List<SongMenu>> implements SongMenuView<List<SongMenu>>, ClickAdapterItemListener<SongMenu> {
    ...
    @Override
    public void onClick(SongMenu eb,int position) {
