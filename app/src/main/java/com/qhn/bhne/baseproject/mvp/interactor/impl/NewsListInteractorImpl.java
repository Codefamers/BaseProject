...
import com.qhn.bhne.baseproject.mvp.interactor.NewsListInteractor;
...
public class NewsListInteractorImpl implements NewsListInteractor<List<NewsSummary>>{
    ...
    public Subscription loadNews(final RequestCallBack<List<NewsSummary>> listener, String type, final String id, int startPage) {
        ...
        // 加一句unsubscribeOn(io)
        return RetrofitManager.getInstance(HostType.TYPE_COUNT).getNewsListObservable(type, id, startPage)
